...
pkgdatadir = $(datadir)/clover
pkgincludedir = $(includedir)/clover
pkglibdir = $(libdir)/clover
pkglibexecdir = $(libexecdir)/clover
...
CONFIG_HEADER = $(top_builddir)/src/config/clover-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/clover-config.h.in \
...
ACLOCAL = ${SHELL} /mnt/c/Users/matthew/Documents/Downloads/clover2-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /mnt/c/Users/matthew/Documents/Downloads/clover2-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /mnt/c/Users/matthew/Documents/Downloads/clover2-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /mnt/c/Users/matthew/Documents/Downloads/clover2-master/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /mnt/c/Users/matthew/Documents/Downloads/clover2-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = clover
PACKAGE_BUGREPORT = www.shamrockchain.org.org
PACKAGE_NAME = Shamrock Core
PACKAGE_STRING = Shamrock Core 2.0.1
PACKAGE_TARNAME = clover
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /mnt/c/Users/matthew/Documents/Downloads/clover2-master
abs_srcdir = /mnt/c/Users/matthew/Documents/Downloads/clover2-master
abs_top_builddir = /mnt/c/Users/matthew/Documents/Downloads/clover2-master
abs_top_srcdir = /mnt/c/Users/matthew/Documents/Downloads/clover2-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /mnt/c/Users/matthew/Documents/Downloads/clover2-master/build-aux/install-sh
...
srcdir = .
subdirs =  src/secp256k1 src/minizip
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/cloverd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/clover-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/clover-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = CLOVER-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_clover_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_clover_coverage.info test_clover.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/CLOVER-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/clover-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/clover-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/clover-config.h
$(top_srcdir)/src/config/clover-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/clover-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/CLOVER-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/CLOVER-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/CLOVER-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_clover.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_clover -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_clover_filtered.info: test_clover.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_clover_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_clover_coverage.info: baseline_filtered_combined.info test_clover_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_clover_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_clover_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_clover_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_clover.coverage/.dirstamp:  test_clover_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_clover.coverage/.dirstamp total.coverage/.dirstamp

# CLOVER: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_clover.coverage/ total.coverage/ $(OSX_APP)
