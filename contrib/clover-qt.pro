...
RESOURCES += src/qt/clover.qrc src/qt/clover_locale.qrc

TRANSLATIONS += src/qt/locale/clover_bg.ts \
                src/qt/locale/clover_de.ts \
                src/qt/locale/clover_en.ts \
                src/qt/locale/clover_es.ts \
                src/qt/locale/clover_fi.ts \
                src/qt/locale/clover_fr.ts \
                src/qt/locale/clover_it.ts \
                src/qt/locale/clover_ja.ts \
                src/qt/locale/clover_pl.ts \
                src/qt/locale/clover_pt.ts \
                src/qt/locale/clover_ru.ts \
                src/qt/locale/clover_sk.ts \
                src/qt/locale/clover_sv.ts \
                src/qt/locale/clover_vi.ts \
                src/qt/locale/clover_zh_CN.ts \
                src/qt/locale/clover_zh_TW.ts
