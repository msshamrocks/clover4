...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Clover features */
        {"clover", "masternode", &masternode, true, true, false},
        {"clover", "listmasternodes", &listmasternodes, true, true, false},
        {"clover", "getmasternodecount", &getmasternodecount, true, true, false},
        {"clover", "masternodeconnect", &masternodeconnect, true, true, false},
        {"clover", "masternodecurrent", &masternodecurrent, true, true, false},
        {"clover", "masternodedebug", &masternodedebug, true, true, false},
        {"clover", "startmasternode", &startmasternode, true, true, false},
        {"clover", "createmasternodekey", &createmasternodekey, true, true, false},
        {"clover", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"clover", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"clover", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"clover", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"clover", "getmasternodescores", &getmasternodescores, true, true, false},
        {"clover", "mnbudget", &mnbudget, true, true, false},
        {"clover", "preparebudget", &preparebudget, true, true, false},
        {"clover", "submitbudget", &submitbudget, true, true, false},
        {"clover", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"clover", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"clover", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"clover", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"clover", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"clover", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"clover", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"clover", "checkbudgets", &checkbudgets, true, true, false},
        {"clover", "mnsync", &mnsync, true, true, false},
        {"clover", "spork", &spork, true, true, false},
        {"clover", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"clover", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cloverd, or the -server option to clover-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"CLOVER Alert\" admin@foo.com\n"),
...
{
    return "> clover-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11917/\n";
}
