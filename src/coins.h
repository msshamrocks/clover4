...
/** 
    ...
    ****Note - for CLOVER we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of clover coming in to a transaction
