...
// Copyright (c) 2016-2017 The CLOVER developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_BLOCK_RECIPIENT_ENFORCEMENT) r = SPORK_17_BLOCK_RECIPIENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_BLOCK_RECIPIENT_ENFORCEMENT") return SPORK_17_BLOCK_RECIPIENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_BLOCK_RECIPIENT_ENFORCEMENT) return "SPORK_17_BLOCK_RECIPIENT_ENFORCEMENT";
