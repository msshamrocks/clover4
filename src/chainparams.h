 ...
 * CLOVER system. There are three: the main network on which people trade goods
...
public:
    ...
    // Validation bypass
    int64_t CloverBadBlockTime() const { return nCloverBadBlockTime; }
    unsigned int CloverBadBlockBits() const { return nCloverBadBlockBits; }
...
protected:
    ...
    // validation by-pass
    int64_t nCloverBadBlockTime;
    unsigned int nCloverBadBlockBits;
    // Masternode Collateral
