...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        bootstrapBlockchain = new QCheckBox(Intro);
        bootstrapBlockchain->setObjectName(QStringLiteral("bootstrapBlockchain"));
        bootstrapBlockchain->setChecked(true);

        verticalLayout->addWidget(bootstrapBlockchain);
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to Shamrock Core.", Q_NULLPTR));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where Shamrock Core will store its data.", Q_NULLPTR));
        sizeWarningLabel->setText(QApplication::translate("Intro", "Shamrock Core will download and store a copy of the CLOVER block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", Q_NULLPTR));
        ...
        bootstrapBlockchain->setText(QApplication::translate("Intro", "Bootstrap from the cloud (wallet syncs with network much faster)", Q_NULLPTR));
    } // retranslateUi
