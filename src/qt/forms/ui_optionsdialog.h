...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeClover = new QSpinBox(tabMain);
        anonymizeClover->setObjectName(QStringLiteral("anonymizeClover"));
        anonymizeClover->setMinimum(100);
        anonymizeClover->setMaximum(100000);
        anonymizeClover->setSingleStep(100);
        anonymizeClover->setValue(1000);

        horizontalLayout->addWidget(anonymizeClover);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start CLOVER after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start CLOVER on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of CLOVER to keep anonymized", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the CLOVER client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the CLOVER network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting CLOVER.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/clover-project/clover-project-translations", Q_NULLPTR));
