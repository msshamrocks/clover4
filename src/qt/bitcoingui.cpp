                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Shamrock Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CLOVER address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and clover: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Shamrock Core"), this);
    aboutAction->setStatusTip(tr("Show information about Shamrock Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CLOVER"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CLOVER addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CLOVER addresses"));
    ...
    openAction->setStatusTip(tr("Open a CLOVER: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Shamrock Core help message to get a list with possible CLOVER command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Shamrock Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CLOVER network", "", count));
}
...
{
    QString strTitle = tr("Shamrock Core"); // default title
