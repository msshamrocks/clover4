...
/** Utility functions used by the CLOVER Qt UI.
 */
namespace GUIUtil
{
...
// Render CLOVER addresses in monospace font
...
// Parse "clover:" URI into recipient object, return true on successful parsing
