Contributing to Shamrock Core
============================

The Shamrock Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Shamrock Core project, and is not to be
confused with overall Shamrock Network Protocol consensus changes.

Whether a pull request is merged into Shamrock Core rests with the project merge
...
Patches that change CLOVER consensus rules are considerably more involved than
...
Where a patch set proposes to change the CLOVER consensus, it must have been
...
The project leader is the release manager for each Shamrock Core release.
