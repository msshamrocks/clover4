...
In order to support loading of multiple wallets in clover-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is clover.cpp.
...
Changes to clover.cpp
----------------------
clover.cpp is the entry point into clover-qt, and as such, will require some minor modifications to provide hooks for
