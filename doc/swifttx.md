...
This mechanism has been integrated into Bitcore-Node-Shamrock which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Shamrock-Project/insight-api-clover#web-socket-api](https://github.com/Shamrock-Project/insight-api-clover#web-socket-api) 
* API: [https://github.com/Shamrock-Project/insight-api-clover#swifttx-transactions](https://github.com/Shamrock-Project/insight-api-clover#swifttx-transactions) 
...
By default, the Shamrock Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Shamrock Core daemon:
